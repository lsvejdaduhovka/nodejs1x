...
let DNYVTYDNU = ["nedele","pondeli","utery","streda","ctvrtek","patek","sobota"];
...
function main(req, res) {
    ...
    if (req.url == "/") {
        ...
        obj.svatek = SVATKY[dt.getMonth()+1][dt.getDate()]; //Alt 91 prip. Alt 93
        obj.denvtydnu = DNYVTYDNU[dt.getDay()];
        res.writeHead(200, "Content-type: application/json");
        res.end(JSON.stringify(obj));
